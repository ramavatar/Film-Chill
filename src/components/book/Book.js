...
export default function Book() {
    ...
    return (
            <>
            <Header />
            <div className="row" style={{backgroundImage:`url("https://wallpaperaccess.com/full/1671323.png")`, backgroundSize:"cover" , position:"relative"}}>
            <h1 className="container-fluid d-flex justify-content-center mt-3">PVR Welcomes you!!!</h1>
